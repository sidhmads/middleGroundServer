...
export class MutationBuilder {
  ...
  constructor(mutationType:string, setParams, whereParams) {
    ...
    const mutationMap = {
      update: squelPostgres.update(Config.pgSqlOptions).table('charities'),
      insert: squelPostgres.insert(Config.pgSqlOptions).into('charities'),
      delete: squelPostgres.delete(Config.pgSqlOptions).from('charities'),
    };
